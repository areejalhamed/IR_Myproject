...
#     """
#     يقوم بعمل clustering للوثائق باستخدام top_results (أول 100).
#     """
...
#         file_path = os.path.join(REPRESENTATIONS_DIR, f"hybrid_embeddings_{table_name}.pkl")
#     else:
...
#     # تحديد أي وثائق نستخدم (top_results)
#     if top_results is not None:
#         top_doc_ids = [doc_id for doc_id, _ in top_results]
